<template>
  <article class="detail-layout">
    ...
    <h2>Gegevens</h2>
    <h3>Over wie?</h3>
    <p>{{ item.personalDataDescription ? item.personalDataDescription.value : "" }}</p>
    ...
    <p>{{ item.formal_framework_clarification ? item.formal_framework_clarification.value : "" }}</p>
    <h2>Ontvangers</h2>
    <ul v-if="item.grantees && item.grantees.value.length > 0" :class="item.grantees.value.length > 5 ? 'columns' : null">
